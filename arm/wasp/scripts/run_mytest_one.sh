...
validate_benchmark_config()
{
	...
	if [ $CURR_CONFIG == "F" ] || [ $CURR_CONFIG == "FM" ] || [ $CURR_CONFIG == "FW" ] || $CURR_CONFIG == "TF" ] || [ $CURR_CONFIG == "TFM" ] || [ $CURR_CONFIG == "TFW" ] || [ $CURR_CONFIG == "FA" ] || [ $CURR_CONFIG == "FAW" ] ||
		[ $CURR_CONFIG == "FAM" ] || [ $CURR_CONFIG == "I" ] || [ $CURR_CONFIG == "IM" ] || [ $CURR_CONFIG == "IW" ]; then
...
test_and_set_configs()
{
        ...
        AUTONUMA="0"
        if [ $CURR_CONFIG == "FA" ] || [ $CURR_CONFIG == "FAM" ] || [ $CURR_CONFIG == "FAW" ] || [ $CURR_CONFIG == "TFA" ] || [ $CURR_CONFIG == "TFAM" ]; then
                AUTONUMA="1"
        fi
        ...
        # --- check interleaving
        if [ $CURR_CONFIG == "I" ] || [ $CURR_CONFIG == "IM" ] || [ $CURR_CONFIG == "IW" ] || [ $CURR_CONFIG == "TI" ] || [ $CURR_CONFIG == "TIM" ]; then
