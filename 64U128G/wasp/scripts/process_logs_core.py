...
configs = ["LPLD", "LPLDI","LPLDIM","LPLDIW","LPRD", "LPRDI", "RPLD", "RPLDI", "RPLDIW", "RPLDIM", "RPILD", "RPRD", "RPIRDI", "RPLDM", "RPILDM", "RPILDW","RPILDA","RPILDAM",
            "TLPLD", "TLPRD", "TLPRDI", "TRPLD", "TRPILD", "TRPRD", "TRPIRDI", "TRPLDM", "TRPILDM",
            "FTLPLD", "FTRPILD", "FTRPILDM",
            "F", "FM", "FW", "FA", "FAM", "FAW", "I", "IM", "IW", "IA", "IAM", "TF", "TFM", "TFW", "TFA", "TFAM", "TI", "TIM"]

pretty_configs = ["LP-LD", "LP-LDI", "LP-LDI+M", "LP-LDI+W","LP-RD", "LP-RDI", "RP-LD", "RP-LDI", "RP-LDI+W", "RP-LDI+M", "RPI-LD", "RP-RD", "RPI-RDI", "RP-LDM", "RPI-LD+M", "RPI-LD+W","RPI-LD+A","RPI-LD+AM",
            "TLP-LD", "TLP-RD", "TLP-RDI", "TRP-LD", "TRPI-LD", "TRP-RD", "TRPI-RDI", "TRP-LD+M", "TRPI-LD+M",
            "FTLP-LD", "FTRPI-LD", "FTRPI-LD+M",
            "F", "F+M", "F+W", "F-A", "F-A+M", "F-A+W", "I", "I+M", "I+W", "I-A", "I-A+M", "TF", "TF+M", "TF+W", "TF-A", "TF-A+M", "TI", "TI+M"]
...
def gen_figure6_csv(path, absolute):
    ...
    fig6_configs = ["LP-LD", "LP-LDI", "LP-LDI+M", "LP-LDI+W", "LP-RD", "LP-RDI", "RP-LD", "RP-LDI", "RPI-LD", "RP-RD", "RPI-RDI"]
...
def gen_figure10_csv(path, thp, absolute):
    ...
    fig10_configs = ["LP-LD", "LP-LDI", "LP-LDI+M", "LP-LDI+W", "RPI-LD", "RPI-LD+M", "RPI-LD+W","RPI-LD+A","RPI-LD+AM",]
    if thp == True:
...
def gen_figure9_csv(path, thp, absolute):
    ...
    fig9_configs = ["F", "F+M", "F+W", "F-A", "F-A+M", "F-A+W", "I", "I+M", "I+W", "I-A", "I-A+M"]
    if thp == True:
        out_file = os.path.join(out_file, "figure9b" + path_suffix + ".csv")
        fig9_configs = ["TF", "TF+M", "TF+W", "TF-A", "TF-A+M", "TI", "TI+M"]
    else:
